...
public final class RatNum extends Number implements Comparable<RatNum> {
  ...
  /** @param n The numerator of the new RatNum.
        ...
        @spec.effects If d = 0, constructs a new RatNum = NaN.  Else
  ...
  /** Makes a RatNum from a string describing it.
        ...
        @spec.requires 'ratStr' is an instance of a string, with no spaces,
        of the form: <UL>
        <LI> "NaN"
        ...
        @return NaN if ratStr = "NaN".  Else returns a
